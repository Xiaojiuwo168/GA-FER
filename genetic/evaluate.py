...
#                 file_name = indi.id
#                 self.log.info('Begin to data %s'%(file_name))
...
#                 cls_obj.do_work('1', file_name)
        ...
        """
        """
        When the codes run to here, it means all the individuals in this generation have been evaluated,
         then to save to the list with the key and value
